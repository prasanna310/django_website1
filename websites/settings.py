...
SECRET_KEY = '%&k+-xml^e@#+sbf-=6+wnhew-mzee*#7d=-m%#wa(=e9l@$ff'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'../pasal/templates'  ) , 
...
DATABASES = {
    'default': {
          ...
          'NAME': os.path.join(BASE_DIR, 'pasal.sqlite3'),
    }
    # 'default': {
...
STATICFILES_DIRS = ( 
                  ...
                  #  os.path.dirname(BASE_DIR) + "/../landing/static" ,  
                  #  os.path.dirname(BASE_DIR) + "/../services/static",
                  # os.path.dirname(BASE_DIR) + "/../pasal/static",
)
